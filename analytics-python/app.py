...
def status():
    ...
    return jsonify({
        ...
        "models": {
            "disaggregator": {
                "trained": _disaggregator is not None and _disaggregator._trained,
                "algorithm": "Combinatorial Optimisation (NILMTK CO)",
            },
            "forecaster": {
                "trained": _forecaster is not None and _forecaster._trained,
                "algorithm": "GradientBoostingRegressor (scikit-learn)",
                "appliance_count": len(_forecaster.models) if _forecaster else 0,
            },
            "anomaly_detector": {
                "trained": _detector is not None and _detector._trained,
                "algorithm": "IsolationForest (scikit-learn)",
                "appliance_count": len(_detector.appliance_models) if _detector else 0,
            },
        },
...
def trigger_run():
    ...
    if _disaggregator is None or not _disaggregator._trained:
        return jsonify({
